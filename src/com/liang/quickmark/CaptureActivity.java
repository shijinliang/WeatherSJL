...
import com.liang.quickmark.R;
import com.liang.quickmark.db.DatabaseUtil;
import com.liang.quickmark.zxing.camera.CameraManager;
import com.liang.quickmark.zxing.control.AmbientLightManager;
import com.liang.quickmark.zxing.control.BeepManager;
import com.liang.quickmark.zxing.decode.CaptureActivityHandler;
import com.liang.quickmark.zxing.decode.FinishListener;
import com.liang.quickmark.zxing.decode.InactivityTimer;
import com.liang.quickmark.zxing.view.ViewfinderView;
	...
	public void onCreate(Bundle icicle) {
		...
		setBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Toast.makeText(CaptureActivity.this, "开发中，谢谢支持！", 0).show();
			}
		});
